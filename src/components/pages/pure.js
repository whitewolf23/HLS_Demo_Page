...
;export default function Pure() {
    ...
    return (
        ...
        <h1>mp4</h1>
        {/* <!-- mp4 링크 --> */}
         <video id="myVideo4" width="640" height="360" src="https://smrmembers-smr.smartmediarep.com/smc/smrmembers/single/eng/0/smr/contents/video/2019/09/23/9c045a87e800017024288980773f3e7b_t34.mp4" controls ></video>       
        </div>
    )
}
